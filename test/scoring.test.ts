...
const REFERENCE: Reference[] = [
  ref("Abe Whitfield",   25.2, { front: 1, back: 10 }, [5,5,4,6,6,5,6,4,6,6,4,5,4,6,6,5,3,6], 19, 92, 73, 73,  0.0, 6.0, 67.0),
  ref("Ben Castellan",   24.8, { front: 2, back: 11 }, [5,4,4,6,5,5,6,4,6,5,5,6,5,7,5,5,4,6], 19, 93, 74, 74, -1.0, 6.5, 67.5),
  ...
  ref("Eli Marsden",     23.6, { front: 9, back: 15 }, [6,6,4,8,5,5,6,3,6,6,5,5,4,4,3,6,4,6], 18, 92, 74, 74, -1.0, 3.5, 70.5),
